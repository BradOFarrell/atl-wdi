...
In this app, users can upload photos to their accounts and share them with others. These photos can be grouped into albums.
  ...
  var photo = {
    img: 'pic.png',
    permissions: new Array, // users
    caption: '',
    height: 800,
    weight: 600, 
  }
  var album = {
    pbhotoArray: new Array() // photos
    description: ''
  }
  ```
...
purchase is complete.
  ...
  var cart = {
    productArray: new Array(), // shoe products
    couponCode: ''
  }
  ```
...
By making the stations a child object of rail lines you lose potential functionality, such as searching to see how many different rail lines hit the same station. It would be better if the station object had an array of all of the rail lines that hits it. 
...
Option 2 makes it easier to get a full picture of the appointment (the time, the doctor, the patient0 from within the appointment object. Neither structure does a good job at showing all the appointments had by the same patient, since the patient objects don't store a record of past appointments, That kind of info would be helpful when loading a patient's chart.
...
a. What are some possible entities that your application might use to model its data? Please pick at least two, with at least two properties apiece.
  ...
  var board = {
    height: 3,
    widtth: 3,
    contents: [][] // matrix of marking objects
  }
  var marking = {
    type: '', // "X" or "O"
    row: 1,
...
I assumed it would be represented as two objects, written similar to how they are written above.

c. Justify your choices in a) and b). Why these entities? Why these representations?

The board would instantiate with a height and width, and contain marking objects. The marking objects would contain their type and the row and column they were created in. Storing this information within the marking would make it easier to check for matches later on. 